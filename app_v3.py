...
def fetch_live_wdc_standings():
    # Attempting Ergast API / OpenF1 alternative response parsing safely
    try:
    ...
    try:
        ...
        # Hardcoded 2026 Season Fallback Matrix
        return pd.DataFrame({
            "Pos": list(range(1, 23)),
            "Driver": [
...
<div style="background-color: rgba(39, 244, 210, 0.1);
    ...
    margin-top: 20px;
">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#27F4D2" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;">
        <polyline points="20 6 9 17 4 12"></polyline>
    </svg>
    <span style="color: #27F4D2; font-weight: 500; font-size: 0.95rem; font-family: 'Segoe UI', sans-serif;">
